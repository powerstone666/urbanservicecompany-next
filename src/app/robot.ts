...
const slugs = [
  ...
  'new-service-location-1', 'new-service-location-2', 'new-service-location-3','microwave-oven-repair',
  'microwave-oven-service', 'microwave-oven-installation', 'microwave-oven-service-center',
  'microwave-oven-repair-service',
  'microwave-oven-installation-service', 'microwave-oven-repair-service-center','microwave-oven-installation-service-center',
  'microwave-oven-repair-service-near-me',
  'microwave-oven-installation-service-near-me', 'microwave-oven-repair-service-in-bangalore','ac-repair',
  'ac-service', 'ac-installation', 'ac-service-center', 'ac-repair-service', 'ac-installation-service',
  'new-ac-repair-service', 'new-ac-installation-service','washing machine repair service',
  'washing machine installation service', 'washing machine repair service center',
  'washing machine installation service center',
